...
<body>
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#"
                        ...
                        <img src="{{ asset('admin/assets/img/profile-img.jpg') }}" alt="Profile"
                            class="rounded-circle">
                        <span class="d-none d-md-block dropdown-toggle ps-2">Yazid Bustomi</span>
                    </a>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <!-- Start Dashboard Nav -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('user.index') }}" onclick="showPage('dashboard')">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('user.magang.index') }}" onclick="showPage('magang')">
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span><a href="https://bootstrapmade.com/">Bustomi</a></span></strong>
        </div>
